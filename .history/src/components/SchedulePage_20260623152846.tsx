    ...
    <div className="w-full min-h-screen bg-[#0d1117] text-slate-200 font-sans flex flex-col">
      ...
      {notification && (
        <div className="fixed top-5 right-5 z-[60] pointer-events-none">
          <div
            className={`px-4 py-3 rounded-2xl shadow-2xl flex items-center gap-2.5 border text-sm font-semibold backdrop-blur-md animate-in slide-in-from-top-2 duration-300 ${
      ...
      >
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span className="font-black text-white tracking-tight text-sm sm:text-base leading-none">MEGATOWN</span>
          </div>

          <div className="hidden sm:flex items-center gap-0.5 px-1.5 py-0.5 rounded-md text-[9px] font-bold uppercase tracking-wider"
          ...
          >
            <button
              ...
              className={`px-2.5 py-1 text-[11px] font-semibold rounded-md cursor-pointer transition-all flex items-center gap-1.5 ${
                viewMode === "sheet"
