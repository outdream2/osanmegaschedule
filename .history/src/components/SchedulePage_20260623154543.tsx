    ...
    <div className="w-full min-h-screen bg-slate-100 text-slate-800 font-sans flex flex-col">
                              ...
                              <div className="flex-1 flex flex-col justify-between py-1 px-1.5 min-w-0">
                                ...
                                <div className="flex items-center gap-0.5 min-w-0">
                                  <span
                                    ...
                                    className="text-indigo-600 hover:text-indigo-800 hover:underline font-bold text-[12px] sm:text-[13px] cursor-pointer select-none transition truncate"
      ...
      {isEmpModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 sm:p-6 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-4 sm:p-6 border border-[#e2e8f0] transform scale-100 transition animate-in zoom-in-95 duration-100 max-h-[90vh] overflow-y-auto">
            <button
