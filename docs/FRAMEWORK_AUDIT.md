...
| `raw-card-wrapper` | 18 | 14 | medium | Card 프리미티브 (padding·variant·clip) |
...
| 2 | `src/components/OcrPage/RawOcrTable.tsx` | 5258 | 32 | large-file(1) · raw-card-wrapper(1) |
| 3 | `src/components/DisplayPage/DisplayPage.tsx` | 3127 | 24 | large-file(1) · raw-card-wrapper(2) |
| 4 | `src/components/OrderManagePage/OrderManagePage.tsx` | 3206 | 20 | large-file(1) |
| 5 | `src/components/LandingPage/LandingPage.tsx` | 2467 | 19 | large-file(1) · raw-card-wrapper(2) |
| 6 | `src/components/StaffManagePage/StaffManagePage.tsx` | 2727 | 17 | large-file(1) · raw-card-wrapper(1) |
| 7 | `src/components/DayTimelineModal/DayTimelineModal.tsx` | 2242 | 15 | large-file(1) |
| 8 | `src/components/LandingPage/VendorListEditor.tsx` | 2038 | 15 | large-file(1) |
| 9 | `src/components/SalesTrendPage/SalesTrendPage.tsx` | 2677 | 15 | large-file(1) |
| 10 | `src/components/SchedulePage/SchedulePage.tsx` | 2379 | 15 | large-file(1) |
| 11 | `src/components/OcrPage/OcrPage.tsx` | 1768 | 13 | large-file(1) · raw-fetch(1) |
| 12 | `src/components/OrderManagePage/PurchaseHistoryTab/PurchaseSubTabs.tsx` | 1214 | 12 | large-file(1) · raw-card-wrapper(1) |
| 13 | `src/components/PermissionsPage/PermissionsPage.tsx` | 1094 | 12 | large-file(1) · raw-card-wrapper(1) |
| 14 | `src/components/ResignationWriterPage/ResignationWriterPage.tsx` | 1241 | 12 | large-file(1) · raw-card-wrapper(1) |
| 15 | `src/components/BoardPage/BoardPage.tsx` | 1177 | 10 | large-file(1) |
| 16 | `src/components/HrFormsPage/HrFormsPage.tsx` | 1123 | 10 | large-file(1) |
...
| 26 | `src/components/LunchPage/LunchPage.tsx` | 561 | 9 | large-file(1) · raw-card-wrapper(2) |
| 27 | `src/App.tsx` | 552 | 8 | large-file(1) · raw-fetch(1) |
| 28 | `src/components/LeavePage/LeavePage.tsx` | 538 | 7 | large-file(1) · raw-card-wrapper(1) |
| 29 | `src/components/SettingsModal/SettingsModal.tsx` | 690 | 7 | large-file(1) · raw-card-wrapper(1) |
| 30 | `src/components/BarcodeScanner/handlers.ts` | 321 | 6 | raw-alert(2) |
...
| `src/components/LandingPage/LandingPage.tsx` | 2467 | 19 |
...
| `src/App.tsx` | 552 | 8 |
| `src/components/LeavePage/LeavePage.tsx` | 538 | 7 |
