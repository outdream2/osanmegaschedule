...
| 4 | `src/components/OrderManagePage/OrderManagePage.tsx` | 851 | 3 | large-file-warn(1) |
| 5 | `src/components/ScanPage/ProductInfoCard.tsx` | 813 | 3 | large-file-warn(1) |
| 6 | `src/components/ScanPage/ScanPage.tsx` | 926 | 3 | large-file-warn(1) |
...
| `src/components/OrderManagePage/OrderManagePage.tsx` | 851 | 3 |
