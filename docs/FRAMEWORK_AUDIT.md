...
| 7 | `src/components/ScanPage/ProductInfoCard.tsx` | 812 | 3 | large-file-warn(1) |
| 8 | `src/components/ScanPage/ScanPage.tsx` | 872 | 3 | large-file-warn(1) |
| 9 | `src/hooks/useAuth.ts` | 291 | 3 | raw-fetch(1) |
...
| `src/components/ScanPage/ProductInfoCard.tsx` | 812 | 3 |
