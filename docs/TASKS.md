...
## 🟢 근로계약서 대형 재작업 · **완료** (2026-08-05 · 8건 통합)

- `33fa02a` · 라벨(계약체결/근무시작) · 시급 default · 카테고리 자동 재로드
- `6c68219` · T-A/T-B/T-D/T-E · 왼쪽 폼 3단계 · 세후 역산 · 카테고리 서명 pad · 근무요일 문구
- `c418962` · T-G~T-N · 휴게 default · 근무장소 동적 · 임금표 이미지 레이아웃 · 근무조건 카드 · PDF A4 2장 · 초기화 UI
- `d5403f0` · 주중/주말 시급 분리
- `d4de13d` · 세전 660 4대보험만 · 임금계산 근무조건 아래 배치
- `a92d47c` · **핵심 fix** · 배수 곱셈 제거 · 통상시급×시간 (WAGE_DIVISOR 296.94)

**검증 예시**: 세후 600만 → 세전 660만 · 통상시급 22,226원 (기본급 464만 + 연장 124만 + 휴일 49만 + 연차 22만 = 660만)

## 🔴 근로계약서 남은 (T-C)

### T-C · 각 호 내용 · 근로계약서 설정에서 편집 (CMS · 미착수)
- 임금 단서 5개 · 징계 13개 · 기타 5개 · 개인정보 4분류 · 각 호 내용 편집 가능
- 저장 · settings 테이블 or contract_clauses 신규 테이블
- 예상 4~5h · 신규 페이지 or SettingsModal 서브탭
