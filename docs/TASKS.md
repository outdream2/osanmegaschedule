...
### #194 · 방문예약 · 대상자 대표/부장/이사 → 대표/이사 축소 (신규 · 2026-08-23)
...
- 🔲 방안 1 · 설정의 매장구역 삭제 → 매장진열 매장구역도로 편집 흡수 (인라인)
- 🔲 방안 2 · StoreZoneMap 편집 UI 통합 → 두 페이지 모두 편집 가능하게
- 🔲 최종 편집 원본 (source of truth) 결정 · useZoneDefs · KV setting
- 🔲 마이그레이션 · 기존 ZoneSettingsPage 삭제 or 리다이렉트
- 💡 **의존** · #181 (인라인 편집 + 드래그) + #189 (구역 클릭 팝업 수정) · 순차 구현
- 💡 프레임워크 원칙 · single source of truth · 재사용 극대화

### #189 · 매장구역도 · 구역 클릭 팝업 · 수정 버튼 (신규 · 2026-08-22)
