...
- StoreMap [진열요청] 버튼 제거 ✅ 완료 (`8c8f515`)
- 담당자 배정 · zone_assignments · dow_map · 전부 유지
- 상태 3단계 · pending → prepared → done
- 3역할 · 요청자 / 창고담당 / 진열담당
- 진열요청 진입점 · ScanPage (바코드 스캔 후)
- product_code FK 컬럼 추가됨 · JOIN 조회 (파생컬럼 X)
- prepared_at/by/name · completed_at/by/name 컬럼 · SQL 실행 완료
