...
import { CheckCircle2, Save, Send, ScanLine, User, X } from "lucide-react";
...
export const ZoneDetailModal: React.FC<ZoneDetailModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="w-full sm:max-w-lg bg-white rounded-t-2xl sm:rounded-2xl shadow-brand-modal max-h-[92vh] flex flex-col overflow-hidden"
      ...
      >
        ...
        <div className="px-5 py-4 border-b border-line flex items-center gap-3 bg-zinc-50">
          ...
          <button onClick={onClose} className="w-8 h-8 rounded-lg hover:bg-zinc-200 flex items-center justify-center text-zinc-500 cursor-pointer">
            <X size={18} />
          </button>
        </div>
