        ...
        <form onSubmit={onSubmit} className="px-5 py-4 space-y-4">
                  ...
                  <>
                    ...
                    {(primary === "기타" || isCustom) && (
                      <input
                        ...
                        className="mt-1.5 w-full text-[14px] rounded border border-line focus:border-brand-deep px-2 py-1.5 bg-white focus:outline-none"
                      />
                    )}
                    {/* 물류 선택시 캐셔 겸직 체크박스 */}
                    {primary === "물류" && (
          ...
          <div className="border border-line rounded-xl p-3">
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 py-2.5 rounded-lg border-2 border-dashed transition cursor-pointer text-[14px] font-semibold ${
                empContractFile
