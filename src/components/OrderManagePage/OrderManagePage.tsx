...
//   · types → OrderManagePage.types.ts  (OrderRequest·ProductInfo·GoodsReceipt·OrderManagePageProps·NeedCategoryFilterKey·OrderNeedShortageBasis·OrderNeedDefaultSortKey·OrderNeedFilterConfig)
//   · utils → OrderManagePage.utils.ts (ORDER_NEED_CONFIG_KEY·DEFAULT_ORDER_NEED_CONFIG·loadOrderNeedConfig·fmtDate)
import type {
  OrderRequest, ProductInfo, GoodsReceipt, OrderManagePageProps,
  NeedCategoryFilterKey, OrderNeedShortageBasis, OrderNeedDefaultSortKey, OrderNeedFilterConfig,
} from "./OrderManagePage.types";
import { ORDER_NEED_CONFIG_KEY, DEFAULT_ORDER_NEED_CONFIG, loadOrderNeedConfig, fmtDate } from "./OrderManagePage.utils";
  ...
  return (
    <main className="flex-1 max-w-[1360px] mx-auto w-full px-4 py-4 flex flex-col gap-4">
            ...
            <div className="px-4 py-2.5 flex flex-wrap items-center gap-x-3 gap-y-2 border-b border-line bg-zinc-50/40">
              ...
              <div className="flex items-center gap-2 flex-nowrap shrink-0">
                ...
                <label className="inline-flex items-center gap-1 shrink-0">
                  ...
                  <input
                    ...
                    placeholder="50"
                    className="w-12 h-7 px-1.5 rounded-md border border-line text-[14px] font-bold text-zinc-800 text-right tabular-nums bg-white
              ...
              {inlineActive && (
                <button
                  ...
                  className="inline-flex items-center gap-1 h-8 px-2.5 rounded-md border border-line bg-white
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="w-20 h-8 px-2 border border-line rounded-lg text-[15px] font-bold text-zinc-800 tabular-nums text-right
              ...
              <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-3 items-center">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    <label className={`text-[15px] font-bold border rounded-lg px-2 py-1 cursor-pointer flex items-center gap-1 ${orderModal.channels.kakao ? "bg-yellow-50 text-yellow-700 border-yellow-300" : "bg-white text-zinc-400 border-line"}`} title="SolAPI 알림톡 (사업자 인증·템플릿·env 필요)">
      ...
      {detailProduct && (
        ...
        >
          <div
            className="bg-white rounded-2xl shadow-brand-modal w-full max-w-2xl max-h-[92vh] flex flex-col overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
