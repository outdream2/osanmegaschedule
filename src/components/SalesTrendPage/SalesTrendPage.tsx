...
// 2026-08-22 · Framework Phase 4 · padDate/lastDayOfMonth/generatePeriods/fillPeriodsWithRows/aggregateToMonths → SalesTrendPage.helpers.ts
import {
  generatePeriods, fillPeriodsWithRows, aggregateToMonths,
} from "./SalesTrendPage.helpers";
// 기존 export 하위 호환
