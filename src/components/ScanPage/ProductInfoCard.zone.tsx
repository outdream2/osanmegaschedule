...
// 2026-09-09 · #15 · 상세구역 라벨링 (매장/창고) + grid 표 정렬 + 모달 편집 (사용자 지시)
  ...
  return (
    <>
      <div className="mb-2 rounded-xl border border-line bg-zinc-50/60 overflow-hidden">
        ...
        {/* 하단 · 매장/창고 상세구역 · 공통 컴포넌트 · storage_locations 기반 동적 */}
        <div className="px-2.5 py-2 border-t border-line bg-white/70">
