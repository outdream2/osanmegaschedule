      ...
      <div className={`${CARD_BASE} px-3 py-2 flex flex-wrap items-center gap-2`}>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <select
            ...
            className="text-[15px] font-semibold border border-line rounded-md px-2 py-1 bg-white cursor-pointer max-w-[140px]"
          >
                ...
                <tbody className="divide-y divide-zinc-50">
                  {supplierTop10.map((r, i) => (
                    <tr key={`sup-${r.key}`} className="hover:bg-zinc-50/60">
                      ...
                      <td className="py-1.5 pl-2 text-right text-zinc-400 tabular-nums text-[14px] w-14">{fmt(r.count)}건</td>
                    </tr>
                  ))}
