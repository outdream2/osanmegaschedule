...
// 2026-08-03 · StockManagePage 본체 삭제 · TrendingTab + 헬퍼만 유지
// (ProductManageView · RawDataView · StockManagePage 컴포넌트 제거)
...
// StockManagePage 컴포넌트 본체 삭제 · 2026-08-03 · 라우팅 없음 · OrderManagePage 서브탭으로 완전 이전
// (TrendingTab · 헬퍼는 위에 유지)
