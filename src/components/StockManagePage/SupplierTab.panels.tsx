                ...
                <table className="w-full text-[14px] min-w-[560px]">
                  <thead className="sticky top-0 bg-white z-10 border-b border-zinc-100">
                    <tr className="text-[15px] text-zinc-400 uppercase tracking-wider">
                      ...
                      <th onClick={() => toggleSupDetailSort("current")} className={`text-right px-1 py-1.5 w-12 cursor-pointer select-none hover:bg-zinc-50 transition ${supDetailSort.key === "current" ? "text-amber-700 font-bold" : "text-amber-500"}`} title="현재고 정렬">현재고{supDetailArrow("current")}</th>
                      ...
                      <th onClick={() => toggleSupDetailSort("purchase_price")} className={`text-right px-1 py-1.5 w-14 cursor-pointer select-none hover:bg-zinc-50 transition ${supDetailSort.key === "purchase_price" ? "text-amber-700 font-bold" : "text-amber-600"}`} title="매입단가 정렬">매입단가{supDetailArrow("purchase_price")}</th>
                      <th onClick={() => toggleSupDetailSort("sale_qty")} className={`text-right px-1 py-1.5 w-14 cursor-pointer select-none hover:bg-zinc-50 transition ${supDetailSort.key === "sale_qty" ? "text-rose-700 font-bold" : "text-rose-600"}`} title="판매량 정렬">판매량{supDetailArrow("sale_qty")}</th>
                      <th onClick={() => toggleSupDetailSort("sale_amount")} className={`text-right px-1 py-1.5 w-16 cursor-pointer select-none hover:bg-zinc-50 transition ${supDetailSort.key === "sale_amount" ? "text-rose-800 font-bold" : "text-rose-700"}`} title="판매금액 정렬">판매금액{supDetailArrow("sale_amount")}</th>
