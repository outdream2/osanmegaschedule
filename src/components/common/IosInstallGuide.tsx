    ...
    <div className="fixed inset-0 z-[70] bg-zinc-950 overflow-y-auto">
      ...
      <div className="sticky top-0 z-10 bg-zinc-900/95 backdrop-blur-md border-b border-white/10 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-white/60 text-[13px]">iOS 정식 웹앱 재설치</div>
          </div>
        </div>
        {onClose && (
          <button
      ...
      <div className="max-w-md mx-auto px-5 py-5">
        <div className="rounded-2xl bg-amber-500/10 ring-1 ring-amber-400/30 p-4">
          <div className="text-amber-200 text-[15px] font-semibold mb-1.5">진단 결과</div>
        ...
        <div className="flex items-center justify-center gap-2 mt-6 mb-4">
          {[1, 2, 3].map((n) => (
            <button
              ...
              className={`w-8 h-8 rounded-full font-bold text-[15px] transition cursor-pointer ${
                step === n
        ...
        {step === 1 && (
          <div className="rounded-2xl bg-zinc-900 ring-1 ring-white/10 p-5">
            <div className="flex items-center gap-2 mb-3">
              <span className="w-7 h-7 rounded-full bg-red-500 text-white font-bold text-[15px] flex items-center justify-center">1</span>
        ...
        {step === 2 && (
          <div className="rounded-2xl bg-zinc-900 ring-1 ring-white/10 p-5">
            <div className="flex items-center gap-2 mb-3">
              <span className="w-7 h-7 rounded-full bg-sky-500 text-white font-bold text-[15px] flex items-center justify-center">2</span>
            ...
            <div className="flex items-center gap-3 mb-4 p-3 rounded-xl bg-sky-500/10 ring-1 ring-sky-400/30">
              ...
              <div className="flex-1">
                ...
                <div className="text-white/60 text-[14px]">파란색 나침반 아이콘</div>
              </div>
            </div>
            <ol className="text-white/80 text-[14px] leading-relaxed space-y-2.5 pl-1">
              ...
              <li className="pl-4">
                <code className="inline-block px-3 py-1.5 rounded-md bg-black/50 text-emerald-300 font-mono text-[15px] font-bold">
                ...
                <button
                  ...
                  className="ml-2 text-[14px] text-sky-300 hover:text-sky-200 underline"
                >
                  주소 복사
                </button>
              </li>
            ...
            <div className="mt-4 pt-4 border-t border-white/10">
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-sky-500/20 hover:bg-sky-500/30 text-sky-200 text-[15px] font-semibold ring-1 ring-sky-400/40 transition cursor-pointer mb-2"
              >
                Safari 로 자동 열기 시도 (베타)
              </button>
              <p className="text-white/50 text-[13px] text-center">위 버튼이 작동 안 하면 · 수동으로 Safari 여세요</p>
            </div>
            <div className="flex gap-2 mt-4">
              <button
                onClick={() => setStep(1)}
                className="px-4 py-3 rounded-xl bg-white/10 hover:bg-white/15 text-white text-[15px] font-semibold transition cursor-pointer"
              >← 이전</button>
              <button
                onClick={() => setStep(3)}
        ...
        {step === 3 && (
          <div className="rounded-2xl bg-zinc-900 ring-1 ring-white/10 p-5">
            <div className="flex items-center gap-2 mb-3">
              <span className="w-7 h-7 rounded-full bg-emerald-500 text-white font-bold text-[15px] flex items-center justify-center">3</span>
              <h3 className="text-white text-[16px] font-bold tracking-tight">정식 웹앱으로 등록</h3>
            </div>
            <div className="text-white/70 text-[14px] mb-3">Safari 안에서:</div>
            ...
            <div className="mt-5 p-3 rounded-xl bg-emerald-500/10 ring-1 ring-emerald-400/30">
              <div className="text-emerald-300 text-[14px] font-bold mb-1">완료 후 · 웹앱 안에서 카메라 정상 작동</div>
        ...
        {diagnostic && (
          <details className="mt-6 rounded-xl bg-zinc-900/70 ring-1 ring-white/5 overflow-hidden">
            <summary className="px-4 py-2.5 text-white/60 text-[14px] font-semibold cursor-pointer hover:bg-white/5 transition">
              기술 진단 정보 (탭)
            </summary>
            <div className="px-4 py-3 border-t border-white/5 font-mono text-[13px] text-white/80 space-y-1 break-all">
